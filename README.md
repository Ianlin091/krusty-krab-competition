# 🍔 吃漢堡比賽：設計模式整合專案 (Krusty Krab Competition)
...
在遊戲中，海綿寶寶與派大星將展開一場 30 秒的比賽吃蟹堡大決鬥！

### 鍵盤操控說明

| 角色 | 動作類型 | 按鍵 | 觸發條件 |
| :--- | :--- | :---: | :--- |
| **海綿寶寶 (左)** | 選擇普通蟹堡 | **`S`** | 隨時可按 |
| **海綿寶寶 (左)** | 選擇黃金蟹堡 | **`D`** | 左方牌子亮起「**黃金蟹堡**」時 |
| **派大星 (右)** | 選擇普通蟹堡 | **`K`** | 隨時可按 |
| **派大星 (右)** | 選擇黃金蟹堡 | **`L`** | 右方牌子亮起「**黃金蟹堡**」時 |
...
4. **倒數開始**：3、2、1，Go！
5. **遊戲進行**：畫面上方會隨機顯示提示牌（普通蟹堡、黃金蟹堡），玩家必須快速按下對應按鍵，率先得到最高分！
...
本專案為十人團隊合作開發。我在此專案中主要負責 **UI 介面開發、Swing 元件排版與流程整合**，核心邏輯與部分設計模式架構由其他組員共同協作完成。
